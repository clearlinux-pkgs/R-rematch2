...
Version  : 2.1.1
Release  : 20
URL      : https://cran.r-project.org/src/contrib/rematch2_2.1.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rematch2_2.1.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585693077
